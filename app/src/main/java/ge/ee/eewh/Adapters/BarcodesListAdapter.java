...
public class BarcodesListAdapter extends ArrayAdapter<BarcodesResult> implements Filterable {

    List<BarcodesResult> _originalItems;
    List<BarcodesResult> _filteredItems;
    String _filterString="";


    public BarcodesListAdapter(Context context, int resource, List<BarcodesResult> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        BarcodesResult p = _filteredItems.get(position);
...
//    @Override
    ...
    Filter myFilter = new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            for (BarcodesResult obj:_originalItems) {
